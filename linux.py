...
def main():
 ...
 \033[1;32m+ -- -- +=[ Author: Karjok Tamvan | Copyright: IndoKarjok\033[1;m
 \033[1;32m+ -- -- +=[ 331 Tools \033[1;m


\033[1;91m[Message] 
Sebelum memperbarui sistem Anda, hapus semua repositori Kali-linux untuk menghindari masalah apa pun.Sekian Tq\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
...
5) Help
			...
			''')
				...
				opcion0 = raw_input("\033[1;36mroot@Karjok:~# \033[1;m")
